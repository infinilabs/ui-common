...
function x({
  ...
  const i = l ? `${l} cursor-pointer` : "cursor-pointer";
  return e ? /* @__PURE__ */ a(
    "a",
    {
      href: e,
  ...
  ) : /* @__PURE__ */ a("button", { type: "button", className: i, onClick: n, children: s });
}
function E({
  item: e,
  onItemClick: t
    ...
    x,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o("div", { className: "mt-2", children: [
          /* @__PURE__ */ a("div", { className: "mb-1 truncate text-sm text-[#1A0CAB] dark:text-[#8AB4F8]", children: e.title }),
          e.subtitle ? /* @__PURE__ */ a("div", { className: "mb-1 truncate text-sm text-[#666]", children: e.subtitle }) : null,
          n.length ? /* @__PURE__ */ a("div", { className: "text-[#666]", children: /* @__PURE__ */ a(b, { breadcrumbs: n }) }) : null
        ] })
      ]
    }
  );
...
function h({
  ...
  return !e && !t && !n ? null : /* @__PURE__ */ o("div", { className: u("mb-2 flex min-w-0 items-center gap-2", l), children: [
    t ? /* @__PURE__ */ a(
      "span",
      {
        className: u(
...
function V(e) {
  switch (e) {
    case "xls":
      return /* @__PURE__ */ a(S, { className: "h-5 w-5" });
    case "ppt":
      return /* @__PURE__ */ a(L, { className: "h-5 w-5" });
    case "pdf":
    case "doc":
    case "word":
    case "text":
...
function O({
  ...
  const r = e.typeIcon ? /* @__PURE__ */ a(k, { typeIcon: e.typeIcon }) : e.fileType ? /* @__PURE__ */ a(k, { fileType: e.fileType }) : null, n = e.onClick || t ? () => {
    e.onClick?.(), t?.(e);
    ...
    /* @__PURE__ */ o("div", { className: "flex gap-3", children: [
      ...
      /* @__PURE__ */ o("div", { className: "min-w-0 flex-1 flex flex-col justify-between", children: [
        e.summary ? /* @__PURE__ */ a("div", { className: "line-clamp-2 text-sm text-[#666]", children: e.summary }) : null,
        e.breadcrumbs?.length || e.author || e.date ? /* @__PURE__ */ o("div", { className: "mt-2 flex min-w-0 items-center gap-3 text-[#666]", children: [
          ...
          /* @__PURE__ */ a("span", { className: "h-3 w-px flex-none bg-[#666]", "aria-hidden": "true" }),
          /* @__PURE__ */ o("div", { className: "flex flex-none items-center gap-2", children: [
            /* @__PURE__ */ a(z, { author: e.author, date: e.date }),
            e.href ? /* @__PURE__ */ a("span", { className: "flex-none text-[#007EFF]", children: /* @__PURE__ */ a(P, { className: "h-3 w-3" }) }) : null
          ] })
        ] }) : /* @__PURE__ */ a(M, { meta: e.meta })
      ] })
    ] })
  ] });
  return !l && !n ? s : /* @__PURE__ */ a(
    x,
    {
      href: l,
      target: e.target,
    ...
    x,
    {
      ...
      children: [
        /* @__PURE__ */ a("div", { className: "overflow-hidden rounded-lg ring-1 ring-slate-200 dark:ring-slate-700", children: /* @__PURE__ */ o("div", { className: "relative aspect-4/3 bg-slate-100 dark:bg-slate-800", children: [
          ...
          e.mediaType === "video" ? /* @__PURE__ */ a("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ a("span", { className: "inline-flex h-10 w-10 items-center justify-center rounded-full bg-black/55 text-white ring-1 ring-white/30", children: /* @__PURE__ */ a(U, { className: "h-5 w-5 translate-x-px" }) }) }) : null
        ] }) }),
        /* @__PURE__ */ o("div", { className: "mt-2", children: [
          /* @__PURE__ */ a("div", { className: "mb-1 truncate text-sm text-[#1A0CAB] dark:text-[#8AB4F8]", children: e.title }),
          e.matchCountText ? /* @__PURE__ */ a("div", { className: "mb-1 truncate text-xs text-[#666]", children: e.matchCountText }) : null,
...
function v({ action: e }) {
  return e ? /* @__PURE__ */ o("div", { className: "mt-4 flex w-full items-center", children: [
    /* @__PURE__ */ a("span", { className: "h-px flex-1 bg-[#e8e8e8] dark:bg-slate-700", "aria-hidden": "true" }),
    /* @__PURE__ */ a(
      J,
      {
        action: e,
...
function K(e, t) {
  if (e.layout === "list")
    return /* @__PURE__ */ o("div", { className: u("space-y-6", e.className), children: [
      /* @__PURE__ */ a(
        h,
        {
          title: e.title,
      ...
      e.items.map((l) => /* @__PURE__ */ a(O, { item: l, onItemClick: t }, l.id)),
      /* @__PURE__ */ a(v, { action: e.footerAction })
    ] });
  if (e.layout === "mediaGrid") {
    const l = e.columns ?? 3, s = l === 2 ? "grid-cols-2" : l === 4 ? "grid-cols-4" : "grid-cols-3";
    return /* @__PURE__ */ o("div", { className: u("px-6 py-3", e.className), children: [
      /* @__PURE__ */ a(
        h,
        {
          title: e.title,
      ...
      /* @__PURE__ */ a("div", { className: u("grid gap-3", s), children: e.items.map((i) => /* @__PURE__ */ a(q, { item: i, onItemClick: t }, i.id)) }),
      /* @__PURE__ */ a(v, { action: e.footerAction })
    ] });
  }
  ...
  return /* @__PURE__ */ o("div", { className: u("px-6 py-3", e.className), children: [
    ...
    /* @__PURE__ */ a("div", { className: u("grid gap-3", n), children: e.items.map((l) => /* @__PURE__ */ a(E, { item: l, onItemClick: t }, l.id)) }),
    /* @__PURE__ */ a(v, { action: e.footerAction })
  ] });
}
function Q(e) {
...
function N(e, t, r) {
  const n = e.thumbnail ?? e.cover ?? e.metadata?.thumbnail_link, l = e.summary ?? e.content, s = W(e.metadata?.file_extension ?? e.type), i = e.source?.name, d = e.category ?? e.categories?.join(" / ") ?? "Categories", c = [i, d].filter(Boolean), f = e.last_updated_by?.user?.username ?? e.owner?.username, p = Q(e.last_updated_by?.timestamp ?? e.metadata?.last_reviewed), m = e.metadata?.icon_link ?? e.icon, y = m ? /* @__PURE__ */ a("img", { src: m, alt: "", className: "h-5 w-5 rounded-sm object-contain" }) : void 0;
  return {
    type: "result",
...
function I({
  ...
  const i = Y(j(e, l), n), d = X(r);
  return /* @__PURE__ */ a("div", { className: u(d === "dark" && "dark", t), children: K(i, s) });
}
function X(e) {
  if (e)
...
function j(e, t) {
  ...
  if (r.type === "imageGroup" && Array.isArray(r.items)) {
    ...
    return i.items[0]?.type === "media" ? {
      ...
      items: i.items.filter(
        (c) => typeof c == "object" && !!c && c.type === "media"
      ),
      columns: i.columns,
      ...
      layout: "imageGrid",
      items: i.items.filter(
        (c) => typeof c == "object" && !!c && c.type === "image"
      ),
      columns: i.columns,
      footerAction: i.footerAction,
      className: i.className
  ...
  const n = r.metadata, l = typeof n == "object" && n ? n.content_type : void 0, s = typeof l == "string" ? l.trim().toLowerCase() : typeof r.type == "string" ? r.type.trim().toLowerCase() : void 0;
  if (s === "image" || s === "video") {
    const i = typeof r.id == "string" ? r.id : void 0, d = typeof r.thumbnail == "string" ? r.thumbnail : typeof r.cover == "string" ? r.cover : typeof r.metadata == "object" && r.metadata && typeof r.metadata.thumbnail_link == "string" ? r.metadata.thumbnail_link : void 0;
    if (d) {
      const c = typeof r.category == "string" ? r.category : Array.isArray(r.categories) ? r.categories.filter((g) => typeof g == "string").join(" / ") : void 0, f = typeof r.title == "string" ? r.title : "Untitled", p = typeof r.url == "string" ? r.url : void 0, m = typeof r.source == "object" && r.source && typeof r.source.name == "string" ? r.source.name : void 0;
      return {
        type: "section",
        layout: "mediaGrid",
        items: [{
          ...
          sourceLabel: m,
          categoryLabel: c,
          breadcrumbs: [m, c].filter(Boolean),
          ...t ? { onClick: () => t(e, 0) } : {}
        }]
      };
    }
...
function Z(e, t) {
  ...
  return r.length && !n.length ? { type: "section", title: A(e, (i) => i.category ?? i.source?.name), layout: "mediaGrid", items: r } : { type: "section", title: A(e, (s) => s.category ?? s.source?.name), layout: "list", items: n };
}
function B(e) {
...
function R(e, t, r) {
  const n = e, l = n.metadata, s = typeof l == "object" && l ? l.content_type : void 0, i = typeof s == "string" ? s.trim().toLowerCase() : typeof n.type == "string" ? n.type.trim().toLowerCase() : void 0;
  if (i !== "image" && i !== "video") return;
  const d = typeof n.id == "string" ? n.id : void 0, c = typeof n.thumbnail == "string" ? n.thumbnail : typeof n.cover == "string" ? n.cover : typeof n.metadata == "object" && n.metadata && typeof n.metadata.thumbnail_link == "string" ? n.metadata.thumbnail_link : void 0;
  if (!c) return;
  const f = typeof n.category == "string" ? n.category : Array.isArray(n.categories) ? n.categories.filter((F) => typeof F == "string").join(" / ") : void 0, p = typeof n.title == "string" ? n.title : "Untitled", m = typeof n.url == "string" ? n.url : void 0, y = typeof n.source == "object" && n.source && typeof n.source.name == "string" ? n.source.name : void 0, g = !!r && !B(e);
  return {
    type: "media",
    id: d ?? `${m ?? p}-0`,
    ...
    sourceLabel: y,
    categoryLabel: f,
    breadcrumbs: [y, f].filter(Boolean),
    ...g ? { onClick: () => r(e, t) } : {}
  };
}
function A(e, t) {
  ...
  for (const n of e) {
    ...
    if (n.type === "imageGroup") {
      n.items[0]?.type === "media" ? r.push({
        type: "section",
        title: n.title,
        titleIcon: /* @__PURE__ */ a(w, { className: "h-4 w-4" }),
        titleIconBgColor: "#FFAF36",
        titleClassName: "text-[#1A0CAB] dark:text-[#8AB4F8]",
        layout: "mediaGrid",
        items: n.items.filter((i) => i.type === "media"),
        columns: n.columns ?? t,
        ...
        titleClassName: "text-[#1A0CAB] dark:text-[#8AB4F8]",
        layout: "imageGrid",
        items: n.items.filter((i) => i.type === "image"),
        columns: n.columns ?? t,
        footerAction: n.footerAction,
        className: n.className
      });
    ...
    if (n.type === "videoGroup") {
      r.push({
        type: "section",
        title: n.title,
        titleIcon: /* @__PURE__ */ a($, { className: "h-4 w-4" }),
...
function le(e) {
  return e.map((t, r) => N(t, r));
}
export {
  ae as SearchResultsImageGroup,
  ie as SearchResultsVideoGroup,
  I as default,
  se as itemsToSections,
  le as recordsToItems
};
