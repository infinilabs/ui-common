      ...
      /* @__PURE__ */ o("div", { className: "min-w-0 flex-1 flex flex-col justify-between", children: [
        ...
        e.breadcrumbs?.length || e.author || e.date ? /* @__PURE__ */ o("div", { className: "mt-2 flex min-w-0 items-center gap-3 text-[#666]", children: [
          ...
          /* @__PURE__ */ o("div", { className: "flex flex-none items-center gap-2", children: [
            ...
            e.href ? /* @__PURE__ */ i("span", { className: "flex-none text-[#007EFF]", children: /* @__PURE__ */ i(D, { className: "h-3 w-3" }) }) : null
          ] })
        ] }) : /* @__PURE__ */ i(E, { meta: e.meta })
      ] })
    ] })
  ] });
...
function q(e, t) {
  if (e.layout === "list")
    return /* @__PURE__ */ o("div", { className: c("space-y-6", e.className), children: [
      ...
      e.items.map((a) => /* @__PURE__ */ i(V, { item: a, onItemClick: t }, a.id)),
  ...
  if (e.layout === "mediaGrid") {
    ...
    return /* @__PURE__ */ o("div", { className: c("px-6 py-3", e.className), children: [
      ...
      /* @__PURE__ */ i("div", { className: c("grid gap-3", l), children: e.items.map((s) => /* @__PURE__ */ i(P, { item: s, onItemClick: t }, s.id)) }),
      /* @__PURE__ */ i(h, { action: e.footerAction })
    ] });
  }
...
function C({
  ...
  const s = W(I(e, a), n), u = Q(r);
  return /* @__PURE__ */ i("div", { className: c(u === "dark" && "dark", t), children: q(s, l) });
}
function Q(e) {
  if (e)
...
export {
  re as SearchResultsImageGroup,
  ne as SearchResultsVideoGroup,
  C as default,
