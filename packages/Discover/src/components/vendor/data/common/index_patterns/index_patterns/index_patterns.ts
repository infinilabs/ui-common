...
export class IndexPatternsService {
  ...
  constructor({
    ...
    this.getIndexPattern = getIndexPattern
  }
  ...
  get = async (
    ...
    const res = await this.getIndexPattern(id);
    const savedObject = {
      "id": id,
      "attributes": {
        "title":          id,
        "fields":         JSON.stringify(convertEsMapping(res?.fields || {})),
        "viewName":       id,
        "timeFieldName":  "",
        "fieldFormatMap": "",
      },
