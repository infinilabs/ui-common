...
import { QuerySuggestionGetFnArgs } from "../../autocomplete/providers/query_suggestion_provider";
          ...
          >
            ...
            >
              {/* <Input.TextArea
                id={this.textareaId}
                ref={(node: any) => {
                  if (node?.resizableTextArea?.textArea) {
                    this.inputRef = node.resizableTextArea.textArea;
                  }
                }}
                ...
                status={this.props.isInvalid ? 'error' : ''}
              /> */}
              <EuiTextArea
                placeholder={this.props.placeholder || "Search"}
                value={this.getQueryString()}
                ...
                onBlur={this.onInputBlur}
                onFocus={this.handleOnFocus}
                className="kbnQueryBar__textarea !shadow-[0_0_transparent,_inset_0_0_0_1px_var(--ant-color-border)] !rounded-6px !bg-[var(--ant-color-bg-container)] !px-5px relative top-1px"
                fullWidth
                rows={1}
                id={this.textareaId}
                autoFocus={
